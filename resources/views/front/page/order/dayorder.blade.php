                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                <h3 class="font-size-15 fa-num bold text-left">{{number_format($food->price)}}
                                                                    <span
                                                                        class="font-size-13 bold text-success">تومان</span>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="col-1 cursor-pointer" onclick="addToCart({{$food->id,1}})">
